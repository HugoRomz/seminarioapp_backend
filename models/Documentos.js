...
DetallesDocumentosAlumno.hasMany(DocumentosAlumnoEstado, { foreignKey: 'det_alumno_id' });
DocumentosAlumnoEstado.belongsTo(DetallesDocumentosAlumno, { foreignKey: 'det_alumno_id' });

DetallesDocumentosDocente.hasMany(DocumentosDocenteEstado, { foreignKey: 'det_docente_id' });
DocumentosDocenteEstado.belongsTo(DetallesDocumentosDocente, { foreignKey: 'det_docente_id' });
